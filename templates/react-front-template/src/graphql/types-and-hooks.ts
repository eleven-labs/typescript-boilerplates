...
export type PokemonItemFragment = { __typename?: 'PokemonItem', id?: number, name?: string };
...
export type PokemonsQuery = { __typename?: 'Query', pokemons?: { __typename?: 'PokemonList', count?: number, results?: Array<{ __typename?: 'PokemonItem', id?: number, name?: string }> } };

export const PokemonItemFragmentDoc = `
...
export const PokemonsDocument = `
    query Pokemons($limit: Int = 3, $offset: Int = 0) {
